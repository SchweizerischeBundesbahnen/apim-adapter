...
/**
 * Code taken from: https://github.com/auth0/jwks-rsa-java/
 */
public class JwkTest {
    ...
    private static final List<String> KEY_OPS_LIST = Collections.singletonList("sign");
    ...
    public void shouldReturnPublicKey() throws Exception {
        ...
        assertThat(jwk.getRsaPublicKey(), notNullValue());
    ...
    public void shouldReturnPublicKeyForEmptyKeyOpsParam() throws Exception {
        final String kid = randomKeyId();
        Map<String, Object> values = publicKeyValues(kid, new ArrayList<>());
        Jwk jwk = Jwk.fromValues(values);
    ...
    private static Map<String, Object> publicKeyValues(String kid, Object keyOps) {
        ...
        values.put("x5c", Collections.singletonList(CERT_CHAIN));
