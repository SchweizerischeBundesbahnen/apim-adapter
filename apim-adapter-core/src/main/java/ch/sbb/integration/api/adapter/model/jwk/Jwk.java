...
/**
 * <p>Represents a JSON Web Key (JWK) used to verify the signature of JWTs</p>
 *
 * <p>Original code taken from: https://github.com/auth0/jwks-rsa-java/blob/master/src/main/java/com/auth0/jwk/Jwk.java <br>
 * not using jwks-rsa-java as a library as it adds additional dependencies that could cause additional dependency conflicts for APIM adapter users</p>
 */
public class Jwk {
     ...
     */
    public RSAPublicKey getRsaPublicKey() throws InvalidPublicKeyException {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("Jwk{");
        sb.append("kid='").append(id).append('\'');
        sb.append(", kyt='").append(type).append('\'');
        sb.append(", alg='").append(algorithm).append('\'');
        sb.append(", use='").append(usage).append('\'');
        sb.append(", extras=").append(additionalAttributes);
        sb.append('}');
        return sb.toString();
    }
}
